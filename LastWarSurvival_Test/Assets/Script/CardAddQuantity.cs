...
public class CardAddQuantity : MonoBehaviour, ISpawnPoolCallbacks
{
    [SerializeField] private bool disableCollidersWhileOnRoad = true;
    ...
    {
        SetRoadCollisionEnabled(!disableCollidersWhileOnRoad);
    }
